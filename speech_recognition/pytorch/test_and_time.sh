...
# run the same hold idx for cpu, gpu and varying batch sizes
	python test.py --cpu 0 --batch_size_val 1 --checkpoint --continue_from models/deepspeech_${1}.pth.tar --use_set ${2} --seed $RANDOM_SEED --acc $TARGET_ACC --hold_idx -1 --hold_sec 1 --n_trials ${5} --force_duration -1
exit 1
