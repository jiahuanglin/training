...
parser.add_argument('--results', default="gpu_flash_storage_scram_rep.csv", help='CSV containing the results of the inferenc runs')
...
#         plt_show_no_blk(t=0.0001)
    ...
    plt.title('Azure NC6 GPU: Scatter plot of inference trials and variances of Librispeech Test Clean inputs')
...
#     plt.savefig("sample_runtime.jpg")
    ...
    plt.title('Azure NC6 GPU: Normalized mean performance plot Librispeech Test Clean inputs')
    plt.xlabel('Idx of input')
    ...
    plt.title('Azure NC6 CPU: Normalized mean performance plot Librispeech Test Clean inputs')
    ...
    plt.title('Azure NC6 GPU: % of batch size 1 inputs from Librispeech Test Clean satisfying a latency bound')
